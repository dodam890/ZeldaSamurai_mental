...
void player::draw(void)
{
	...
	case player::LINK_MOTION_LEFT:
		TextOut(getMemDC(), 500, 10, "왼쪽기본", strlen("왼쪽기본"));
		break;
	case player::LINK_MOTION_UP:
		TextOut(getMemDC(), 500, 10, "위쪽기본", strlen("위쪽기본"));
		break;
	case player::LINK_MOTION_DOWN:
		TextOut(getMemDC(), 500, 10, "아래쪽기본", strlen("아래쪽기본"));
		break;
	case player::LINK_MOTION_RIGHT_WALK:
		TextOut(getMemDC(), 500, 10, "오른쪽걷기", strlen("오른쪽걷기"));
		break;
	case player::LINK_MOTION_LEFT_WALK:
		TextOut(getMemDC(), 500, 10, "왼쪽걷기", strlen("왼쪽걷기"));
		break;
	case player::LINK_MOTION_UP_WALK:
		TextOut(getMemDC(), 500, 10, "위쪽걷기", strlen("위쪽걷기"));
		break;
	case player::LINK_MOTION_DOWN_WALK:
		TextOut(getMemDC(), 500, 10, "아래쪽걷기", strlen("아래쪽걷기"));
		break;
	case player::LINK_MOTION_RIGHT_TUMBLE:
		TextOut(getMemDC(), 500, 10, "오른쪽구르기", strlen("오른쪽구르기"));
		break;
	case player::LINK_MOTION_LEFT_TUMBLE:
		TextOut(getMemDC(), 500, 10, "왼쪽구르기", strlen("왼쪽구르기"));
		break;
	case player::LINK_MOTION_UP_TUMBLE:
		TextOut(getMemDC(), 500, 10, "위쪽구르기", strlen("위쪽구르기"));
		break;
	case player::LINK_MOTION_DOWN_TUMBLE:
		TextOut(getMemDC(), 500, 10, "아래쪽구르기", strlen("아래쪽구르기"));
		break;
	case player::LINK_MOTION_RIGHT_GRAB:
		TextOut(getMemDC(), 500, 10, "오른쪽잡기", strlen("오른쪽잡기"));
		break;
	case player::LINK_MOTION_LEFT_GRAB:
		TextOut(getMemDC(), 500, 10, "왼쪽잡기", strlen("왼쪽잡기"));
		break;
	case player::LINK_MOTION_UP_GRAB:
		TextOut(getMemDC(), 500, 10, "위쪽잡기", strlen("위쪽잡기"));
		break;
	case player::LINK_MOTION_DOWN_GRAB:
		TextOut(getMemDC(), 500, 10, "아래쪽잡기", strlen("아래쪽잡기"));
		break;
	case player::LINK_MOTION_RIGHT_PUSH:
		TextOut(getMemDC(), 500, 10, "오른쪽밀기", strlen("오른쪽밀기"));
		break;
	case player::LINK_MOTION_LEFT_PUSH:
		TextOut(getMemDC(), 500, 10, "왼쪽밀기", strlen("왼쪽밀기"));
		break;
	case player::LINK_MOTION_UP_PUSH:
		TextOut(getMemDC(), 500, 10, "위쪽밀기", strlen("위쪽밀기"));
		break;
	case player::LINK_MOTION_DOWN_PUSH:
		TextOut(getMemDC(), 500, 10, "아래쪽밀기", strlen("아래쪽밀기"));
		break;
	case player::LINK_MOTION_RIGHT_SWORD_ATTACK:
		TextOut(getMemDC(), 500, 10, "오른쪽칼공격", strlen("오른쪽칼공격"));
		break;
	case player::LINK_MOTION_LEFT_SWORD_ATTACK:
		TextOut(getMemDC(), 500, 10, "왼쪽칼공격", strlen("왼쪽칼공격"));
		break;
	case player::LINK_MOTION_UP_SWORD_ATTACK:
		TextOut(getMemDC(), 500, 10, "위쪽칼공격", strlen("위쪽칼공격"));
		break;
	case player::LINK_MOTION_DOWN_SWORD_ATTACK:
		TextOut(getMemDC(), 500, 10, "아래쪽칼공격", strlen("아래쪽칼공격"));
		break;
	case player::LINK_MOTION_RIGHT_SHIELD_OPEN:
		TextOut(getMemDC(), 500, 10, "오른쪽쉴드꺼내기", strlen("오른쪽쉴드꺼내기"));
		break;
	case player::LINK_MOTION_LEFT_SHIELD_OPEN:
		TextOut(getMemDC(), 500, 10, "왼쪽쉴드꺼내기", strlen("왼쪽쉴드꺼내기"));
		break;
	case player::LINK_MOTION_UP_SHIELD_OPEN:
		TextOut(getMemDC(), 500, 10, "위쪽쉴드꺼내기", strlen("위쪽쉴드꺼내기"));
		break;
	case player::LINK_MOTION_DOWN_SHIELD_OPEN:
		TextOut(getMemDC(), 500, 10, "아래쪽쉴드꺼내기", strlen("아래쪽쉴드꺼내기"));
		break;
	case player::LINK_MOTION_RIGHT_SHIELD_STAND:
		TextOut(getMemDC(), 500, 10, "오른쪽쉴드기본", strlen("오른쪽쉴드기본"));
		break;
	case player::LINK_MOTION_LEFT_SHIELD_STAND:
		TextOut(getMemDC(), 500, 10, "왼쪽쉴드기본", strlen("왼쪽쉴드기본"));
		break;
	case player::LINK_MOTION_UP_SHIELD_STAND:
		TextOut(getMemDC(), 500, 10, "위쪽쉴드기본", strlen("위쪽쉴드기본"));
		break;
	case player::LINK_MOTION_DOWN_SHIELD_STAND:
		TextOut(getMemDC(), 500, 10, "아래쪽쉴드기본", strlen("아래쪽쉴드기본"));
		break;
	case player::LINK_MOTION_RIGHT_SHIELD_MOVE:
		TextOut(getMemDC(), 500, 10, "오른쪽쉴드무브", strlen("오른쪽쉴드무브"));
		break;
	case player::LINK_MOTION_LEFT_SHIELD_MOVE:
		TextOut(getMemDC(), 500, 10, "왼쪽쉴드무브", strlen("왼쪽쉴드무브"));
		break;
	case player::LINK_MOTION_UP_SHIELD_MOVE:
		TextOut(getMemDC(), 500, 10, "위쪽쉴드무브", strlen("위쪽쉴드무브"));
		break;
	case player::LINK_MOTION_DOWN_SHIELD_MOVE:
		TextOut(getMemDC(), 500, 10, "아래쪽쉴드무브", strlen("아래쪽쉴드무브"));
		break;
	case player::LINK_MOTION_RIGHT_MAGICPOT_ABSORB:
		TextOut(getMemDC(), 500, 10, "오른쪽항아리흡수", strlen("오른쪽항아리흡수"));
		break;
	case player::LINK_MOTION_LEFT_MAGICPOT_ABSORB:
		TextOut(getMemDC(), 500, 10, "왼쪽항아리흡수", strlen("왼쪽항아리흡수"));
		break;
	case player::LINK_MOTION_UP_MAGICPOT_ABSORB:
		TextOut(getMemDC(), 500, 10, "위쪽항아리흡수", strlen("위쪽항아리흡수"));
		break;
	case player::LINK_MOTION_DOWN_MAGICPOT_ABSORB:
		TextOut(getMemDC(), 500, 10, "아래쪽항아리흡수", strlen("아래쪽항아리흡수"));
		break;
	case player::LINK_MOTION_RIGHT_MAGICPOT_FIRE:
		TextOut(getMemDC(), 500, 10, "오른쪽항아리발싸", strlen("오른쪽항아리발싸"));
		break;
	case player::LINK_MOTION_LEFT_MAGICPOT_FIRE:
		TextOut(getMemDC(), 500, 10, "왼쪽항아리발싸", strlen("왼쪽항아리발싸"));
		break;
	case player::LINK_MOTION_UP_MAGICPOT_FIRE:
		TextOut(getMemDC(), 500, 10, "위쪽항아리발싸", strlen("위쪽항아리발싸"));
		break;
	case player::LINK_MOTION_DOWN_MAGICPOT_FIRE:
		TextOut(getMemDC(), 500, 10, "아래쪽항아리발싸", strlen("아래쪽항아리발싸"));
		break;
	case player::LINK_MOTION_RIGHT_ROLLING_ATTACK:
		TextOut(getMemDC(), 500, 10, "오른쪽롤링썬더", strlen("오른쪽롤링썬더"));
		break;
	case player::LINK_MOTION_LEFT_ROLLING_ATTACK:
		TextOut(getMemDC(), 500, 10, "왼쪽롤링썬더", strlen("왼쪽롤링썬더"));
		break;
	case player::LINK_MOTION_UP_ROLLING_ATTACK:
		TextOut(getMemDC(), 500, 10, "위쪽롤링썬더", strlen("위쪽롤링썬더"));
		break;
...
void player::motionChange(void)
{
	...
	{
		SOUNDMANAGER->play("젤다검기본소리", 1.f);
		SOUNDMANAGER->play("젤다기본베기기합", 1.f);
	...
	{
		SOUNDMANAGER->play("젤다검회전소리", 1.f);
		SOUNDMANAGER->play("젤다회전베기기합", 1.f);
