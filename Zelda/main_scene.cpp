...
void main_scene::update()
{
	...
	//음악꺼줌
	if (SOUNDMANAGER->isPlaySound("마을음악"))
		SOUNDMANAGER->stop("마을음악");
	if (SOUNDMANAGER->isPlaySound("상점음악"))
		SOUNDMANAGER->stop("상점음악");
	if (SOUNDMANAGER->isPlaySound("던전음악"))
		SOUNDMANAGER->stop("던전음악");
