...
#define SAMPLETILEX4 3
#define SAMPLETILEY4 1
#define SAMPLETOTAL4 SAMPLETILEX4 * SAMPLETILEY4
...
enum TERRAIN
{
	TR_BASE, TR_GRASS, TR_DESERT, TR_WATER, TR_ROCK, TR_END
};
...
enum OBJECT
{
	...
	OBJ_BOX1, OBJ_BOX2, OBJ_DOOR_UP_CLOSE, OBJ_DOOR_UP_OPEN, OBJ_DOOR_DOWN_CLOSE, OBJ_DOOR_DOWN_OPEN,
	OBJ_DOOR2_UP_CLOSE, OBJ_DOOR2_UP_OPEN, OBJ_DOOR2_DOWN_CLOSE, OBJ_DOOR2_DOWN_OPEN, OBJ_NONE,
	OBJ_SNAIL, OBJ_OCTOPUS, OBJ_SLIME
};
